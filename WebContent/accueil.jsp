...
<h3><center>
Bienvenu sur le site de reservation de notre Hotel BEATRICE <br> Réservez et payez et toute sécurité. </center>
</h3>
</div>

   <a href="connexionClient.jsp">  <button id="connexion" >
    CONNEXION</button> </a>
     <a href="inscriptionClient.jsp">  <button id="inscription" >
